...
<body>
	...
	<section id="container" class="">
		...
		<header class="header dark-bg">
			...
			<!--logo start-->
			<a href="index.php" class="logo">admissione <span class="lite">Admin</span></a>
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="active">
						<a class="" href="index.php?managecontact">
...
<?php
		 }else if(isset($_GET['managecontact'])){
?>
<div class="row">
					<div class="col-lg-12">
						<section class="panel">
					...
					<?php
					$contact_request = getAllContactRequests($db);
					$count=1;
					foreach($contact_request as $cr){
						?>
<tr>
										<td><?=$count?></td>
										<td><?=date('F jS, Y',strtotime($cr['contacted_at']))?></td>
										<td><?=$cr['name']?></td>
										<td><?=$cr['phone']?></td>
										<td><?=$cr['email']?></td>
										<td><?=$cr['school']?></td>
										<td style="max-width: 300px"><?=$cr['message']?></td>
										<td><?php if ($cr['is_contacted'] == 1) { ?>
													<div class="btn-group"><p class="text-success"><i class="icon_check_alt2"></i></p></dv>
											<?php } else { ?>
													<div class="btn-group"> <p class="text-danger"><i class="icon_close_alt2"></i></p></dv>
											<?php } ?>
										</td>
									 
										<td>
											<div class="btn-group">
												<a class="btn btn-success" href="../includes/mark_contacted.php?id=<?=$cr['id']?>&prev_status=<?=$cr['is_contacted']?>">mark-contacted <i class="icon_check_alt2"></i></a>
												<a class="btn btn-danger" href="../includes/remove_contact.php?id=<?=$cr['id']?>">Remove <i class="icon_close_alt2"></i></a>
											</div>
										</td>
									</tr>
						<?php
